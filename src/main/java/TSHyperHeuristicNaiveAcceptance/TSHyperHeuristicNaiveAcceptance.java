 ...
 * @author mvh
 */
public class TSHyperHeuristicNaiveAcceptance extends HyperHeuristic {
	AcceptanceCriteria acceptanceCriteria;

	public TSHyperHeuristicNaiveAcceptance(long seed) {
		super(seed);
	}//end constructor
...
//			System.out.println(problem.solutionToString(0));
			//System.out.println(problem.getFunctionValue(0));
	...
	public String toString() {
		return "Tabu Search Naive Acceptance";
	}
