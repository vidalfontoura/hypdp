...
public class TestHH extends HyperHeuristic {
	
	/**
	 * creates a new ExampleHyperHeuristic object with a random seed
	 */
	public TestHH(long seed){
		super(seed);
	}
	...
	public void solve(ProblemDomain problem) {
		...
		while (!hasTimeExpired()) {
			...
			double new_obj_function_value = problem.applyHeuristic(heuristic_to_apply, 0, 1, 2);
