...
public class LoopMoveOperatorTest {
	...
	public void setup() {
		...
		operator = new LoopMoveOperator(random, 1.0);
	}
	...
	public void test1() {
		...
		Assert.assertTrue(Arrays.equals(new int[] { 0, 2, 2, 0, 1, 2, 2, 0, 1, 2, 1, 2, 1, 1, 0, 0, 2, 0 }, offspring));
		...
		Assert.assertTrue(
				Arrays.equals(new int[] { 0, 2, 2, 0, 1, 1, 2, 0, 1, 2, 2, 2, 1, 1, 0, 0, 2, 0 }, subOffspring));
		...
		Assert.assertTrue(
				Arrays.equals(new int[] { 0, 2, 2, 0, 1, 1, 2, 0, 1, 2, 2, 2, 1, 1, 0, 0, 2, 0 }, subSubOffspring));
